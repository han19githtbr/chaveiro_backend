...
const notifications: Prisma.NotificationCreateInput[] = [
  ...
  },
  {
    ...
    service: 'Conserto',
    phone: '(11) 98765-4321',
    imageUrl: 'https://areademulher.r7.com/wp-content/uploads/2020/03/pessoas-mais-lindas-do-mundo-as-10-mais-bonitas-2.jpg',
    createdAt: new Date(),
  },
  {
    ...
    service: 'Cópia',
    phone: '(11) 90761-4121',
    imageUrl: 'https://www.resilienciamag.com/content/uploads/2016/06/famosa.jpg',
    createdAt: new Date(),
  },
